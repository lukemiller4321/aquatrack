...
## What this app does
Automatically captures unanswered emails (via Gmail API polling) into a PostgreSQL
database. Staff use the dashboard to follow up and track leads through to enrollment.
