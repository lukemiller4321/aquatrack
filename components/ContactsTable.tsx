...
const TYPE_OPTIONS = ['all', 'call', 'email', 'sms', 'other'];
                ...
                <tbody className="divide-y divide-gray-100">
                  {filtered.map(c => (
                    <tr key={c.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700 whitespace-nowrap">{c.contact}</td>
                      <td className="px-4 py-3 text-xs">
                        {c.type === 'call' ? (
                          <span className="rounded px-2 py-0.5 font-medium text-white" style={{ backgroundColor: '#CC0000' }}>
                            Missed Call
                          </span>
                        ) : (
                          <span className="rounded bg-gray-100 px-2 py-0.5 font-medium text-gray-600 capitalize">
                      ...
                      <td className="px-4 py-3">
                        <select
                          ...
                          className="text-xs border border-gray-200 rounded px-2 py-1 bg-white focus:outline-none disabled:opacity-50"
                      ...
                      <td className="px-4 py-3 min-w-[180px]">
                        {editingId === c.id ? (
                          ...
                          <button
                            ...
                            className="text-xs text-gray-500 hover:text-gray-800 text-left w-full truncate max-w-[160px]"
